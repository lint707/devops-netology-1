...
var game0cases = [][]gameCase{
	...
	{
		{100, "осмотреться", "ты находишься на кухне, на столе: чай, надо собрать рюкзак и идти в универ. можно пройти - коридор"}, // действие осмотреться кухня
		...
		{400, "осмотреться", "на столе: ключи, конспекты, на стуле: рюкзак. можно пройти - коридор"}, // действие осмотреться комната
	...
	// этот блок на всякие граничные случаи, которые вы должны уметь обрабатывать. именно за счет него вам не получится все жестко захардкодить
	{
		...
		{700, "осмотреться", "на столе: ключи, конспекты, на стуле: рюкзак. можно пройти - коридор"}, // действие осмотреться комната
		{800, "взять ключи", "некуда класть"},                                                        // надо взять рюкзак сначала
		{900, "надеть рюкзак", "вы надели: рюкзак"},
		{1000, "осмотреться", "на столе: ключи, конспекты. можно пройти - коридор"}, // состояние изменилось						// действие осмотреться комната
		...
		{1003, "осмотреться", "на столе: ключи, конспекты. можно пройти - коридор"}, // действие осмотреться комната
		...
		{1400, "осмотреться", "на столе: конспекты. можно пройти - коридор"}, // состояние изменилось								// действие осмотреться комната
		...
		{1900, "осмотреться", "ты находишься на кухне, на столе: чай, надо идти в универ. можно пройти - коридор"}, // состояние изменилось // действие осмотреться кухня
